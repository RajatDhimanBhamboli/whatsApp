  ...
  return (
    <div className={styles.nav}>
      ...
      <div className={styles.emoji2}>
        <span className={styles.icon2} onClick={() => setactivetab("setting")}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="30"
            data-tooltip-id="hlo5"
