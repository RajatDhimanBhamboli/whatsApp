...
import style from "../links/Setting.module.css";
      ...
      <div className={style.settingsOption}>
        <ul className={style.ul}>
          <li className={style.lists}>
            <Image image={dp} />
            <p className={style.p1}>{name.toUpperCase()}</p>
          </li>
          <li className={style.lists}>
            <svg
          ...
          <li className={style.lists}>
            ...
            <p className={style.p}>Keyboard Shortcut</p>
          </li>
          <li className={style.lists}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p className={style.p}>Help Center</p>
          </li>
        </ul>
        <button
